...
import { Shield, Heart, Bell, MapPin, Battery, Wifi, Search } from 'lucide-react-native';
import {
  ScreenContainer,
  Button,
  TextInput,
...
/**
 * Phase 0 — Design System Test Screen
 *
 * This is a temporary screen to visually verify all design tokens
 * and reusable components. It will be replaced in Phase 1.
 */
export default function DesignSystemTestScreen() {
  return (
    <ScreenContainer>
      ...
      <Text style={[Typography.h1, { color: Colors.textPrimary }]}>Heading 1</Text>
      <Text style={[Typography.h2, { color: Colors.textPrimary }]}>Heading 2</Text>
      <Text style={[Typography.h3, { color: Colors.textPrimary }]}>Heading 3</Text>
      ...
      <View style={[styles.badgeRow, { marginTop: Spacing.sm }]}>
        ...
        <StatusBadge status="critical" size="sm" label="SOS" />
      </View>
